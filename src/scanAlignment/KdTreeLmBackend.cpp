                                        ...
                                        std::optional<AlignmentOverrideConfig> overrideConfig)
{
    ...
    lastJacobianDegeneracyInfo = JacobianDegeneracyInfo();
    ...
    if (overrideConfig.has_value())
    {
        ...
        if (overrideConfig->compute_jacobian_degeneracy.has_value())
            computeJacobianDegeneracyThisRun = *overrideConfig->compute_jacobian_degeneracy;
        if (overrideConfig->jacobian_degeneracy_threshold.has_value())
...
AlignmentOverrideConfig KdTreeLmBackend::getAlignmentConfig() const
{
    ...
    config.compute_jacobian_degeneracy = true;
    config.jacobian_degeneracy_threshold = 1e-3f;
    return config;
}
